package com.hour24.toysrental.common.view.floatingbutton;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonSize =
                       attr.getInt(R.styleable.FloatingActionsMenu_fab_addButtonSize, FloatingActionButton.SIZE_NORMAL);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                int buttonsHorizontalCenter = mLabelsPosition == LABELS_ON_LEFT_SIDE ? r - l - mMaxButtonWidth / 2
                                                                                     : mMaxButtonWidth / 2;
                ...
                int nextY = expandUp ? addButtonY - mButtonSpacing
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    if (label != null) {
                        ...
                        int labelLeft =
                                      mLabelsPosition == LABELS_ON_LEFT_SIDE ? labelXAwayFromButton : labelsXNearButton;
